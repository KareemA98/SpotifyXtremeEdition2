...
public class ExplicitAdapter extends RecyclerView.Adapter<ExplicitAdapter.MyViewHolder> {

    private List<Explicit> genreList;
    ...
    public ExplicitAdapter(List<Explicit> genreList , Context context) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final Explicit genre = genreList.get(position);
